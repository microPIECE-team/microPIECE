...
The target prediction of the 430 miRNAs on the transfered CLIP regions from microPIECE resulted in 3010 miRNA-target interactions. Outgoing from the previously reported 2.203.593 possible microRNA-target interactions, we reduced the results to a very conservative set.
